        ...
        <div className="today">
          <div className="sessions">
            ...
            <div className="info">
              ...
              <div className="weather-info">{WeatherData.feels}°C</div>
            </div>
          </div>
          <div className="sessions">
            MAX TEMPERATURE <br />
            <div className="info">
              ...
              <div className="weather-info">{WeatherData.maxTemp}°C</div>
            </div>
          </div>
          <div className="sessions">
            MIN TEMPERATURE <br />
            <div className="info">
              ...
              <div className="weather-info">{WeatherData.minTemp}°C</div>
            </div>
          </div>
        </div>
